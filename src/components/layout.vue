<template>
  <div>
      ...
      <div class="app-head-inner">
        ...
        <div class="head-nav">
          <ul class="nav-list">
            ...
            <li><a v-if="username === '' " @click="logClick">登录</a></li>
            <li class="nav-pile">|</li>
            <li><a v-if="username === '' " @click="regClick">注册</a></li>
            <li class="nav-pile" v-if="username === '' ">|</li>
            <li><a @click="aboutClick">关于我</a></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="app-footer">
      <p>@2018 shaun  publish copyright </p>
    </div>
    ...
    <my-dialog :is-show="isShowLogDialog" @on-close="closeDialog('isShowLogDialog')">
      <logs-form @has-log="onSuccessLog"></logs-form>
    </my-dialog>
